...
random_photo = [
    "https://files.catbox.moe/43w0rf.jpg",
    "https://files.catbox.moe/3aso5y.jpg",
    "https://files.catbox.moe/kiiczm.jpg",
    "https://files.catbox.moe/94lgrb.jpg",
]
# --------------------------------------------------------------------------------- #
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("Clonify/assets/NOBITAWLCM.png")
